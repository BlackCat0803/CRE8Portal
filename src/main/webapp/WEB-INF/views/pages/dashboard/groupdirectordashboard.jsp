<%--
Front End UI to view the Group Director Dashboard
 --%>
									...
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left">
										<div class="row form-group">
											...
											<div class="col-md-1 col-sm-1 col-xs-12">
												<!-- <button type="button" class="btn btn-primary">Create New Physician</button> -->
											...
											<div class="col-md-1 col-sm-1 col-xs-12 text-center">
												...
												<c:choose>
													<c:when test="${loginDetail.type == 'Group Director'}">
														<form:hidden path="groupId" id="groupId" value="${groupId}" />
													</c:when>
													<c:otherwise>
...
<script src="${pageContext.request.contextPath}/resources/js/pages/dashboard/groupdirectordashboard.js?v=4"></script>