<%--
Front End UI to view the Admin Dashboard
 --%>
...
<form:form method="POST" name="form" commandName="form">
	<div class="">
		<div class="row top_tiles">
			<div class="row">
									...
									<div class="row form-group">
										<div class="col-md-4 col-sm-4 col-xs-12">
												<div class="select2-wrapper">
													<select id="notificationtype"  name="notificationtype" class="form-control" onchange="showOrHideNotificationSearch();">
			                        		...
			                        		<div class="col-md-3 col-sm-3 col-xs-12 form-group">
												<input type="text" id="notifyStartDate" placeholder="From" class="form-control calendarIcon startDate" style="width:100%;color:black;">
			                        		</div>
			                      	
			                        		<div class="col-md-3 col-sm-3 col-xs-12 form-group">
												<input type="text" id="notifyEndDate" placeholder="To" class="form-control calendarIcon endDate" style="width:100%;color:black;">
			                        		</div>
											<div class="col-md-1 col-sm-1 col-xs-12 ">
												<img style="cursor: pointer" class="img-responsive image-center" id="newNotifySearch" src="${pageContext.request.contextPath}/resources/images/search3.png"   title="Search">
											</div>
											<div class="col-md-1 col-sm-1 col-xs-12 ">
												<img style="cursor: pointer" class="img-responsive image-center" id="clearNotifySearch" src="${pageContext.request.contextPath}/resources/images/search-cancel2.png"   title="Clear">
											</div>
									</div>
									<div class="row form-group">
										<div class="col-md-3 col-sm-3 col-xs-12 form-group" id="notifyRxNoDiv" style="display:none;">
												<input type="text" id="notifyRxNo" placeholder="Rx #" class="form-control" style="width:100%;color:black;">
			                        	</div>
			                        	<div class="col-md-3 col-sm-3 col-xs-12 form-group" id="notifyReferenceNoDiv" style="display:none;">
												<input type="text" id="notifyReferenceNo" placeholder="Reference #" class="form-control" style="width:100%;color:black;">
			                        	</div>
			                        	<div class="col-md-5 col-sm-5 col-xs-12 form-group" id="notifyPatientNameDiv" style="display:none;">
												<input type="text" id="notifyPatientName" placeholder="Patient Name" class="form-control" style="width:100%;color:black;">
												<input type="hidden" id="notifyPhysicianName">
			                        	</div>
									</div>
									<p></p>
									<div class="table-responsive">
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left table-responsive" style="overflow-y: auto;height: 220px">
											<table id="notificationSummaryTable" class="table table-striped jambo_table bulk_action" border="2">
												...
												<thead>
													...
													<!-- <tr class="heading_background text-left">
														<td>Dr.
														<u>Test Physician</u>
														Info Changed 
														on 
													...
													<tr class="heading_background text-left">
														<td>New Patient
														<u>	Test Patient1002</u>
														added  
														on 
														02/21/2018</td>
													</tr>
													<tr class="heading_background text-left">
														<td>Reference #:<u>CRE8-1000</u>,RX #:1002,TEST PATIENT201,11/17/2017,Lipitor 10 mg tablet</td>
													</tr>
													<tr class="heading_background text-left">
 														<td>Reference #:<u>	CRE8-1000</u>,RX #:1002,TEST PATIENT201,11/17/2017,Tracking No. Generated</td>
 													</tr>
 													<tr class="heading_background text-left">
 														<td>Reference #:<u>	CRE8-1000</u>,RX #:1002,TEST PATIENT201,11/17/2017,Not Paid</td>
													</tr> -->
											</table>
										</div>
									</div>
					...
					<div class="col-md-6 col-sm-6 col-xs-12 bgcolorblue2">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left dashboardBox" style="padding:4px"><br></br>
						<div class="animated flipInY col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="tile-stats">
								...
								<br>
								<h4 style="font-weight:bold;color:#BAB8B8;font-size:17px">New Prescriptions</h4>
								<p></p>
							</div>
						</div>
						<div class="animated flipInY col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="tile-stats">
								...
								<br>
								<h4 style="font-weight:bold;color:#BAB8B8;font-size:17px">Total Refills</h4>
								<p></p>
							</div>
						</div>
						<div class="animated flipInY col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="tile-stats">
								...
								<br>
								<h4 style="font-weight:bold;color:#BAB8B8;font-size:17px">Total Invoice Paid</h4>
								...
								<div class="x_content bgcolorblue1">
									<div class="row">
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left">
											<div class="row form-group">
												...
												<div class="col-md-1 col-sm-1 col-xs-12">
													<img  style="cursor: pointer" class="img-responsive image-center" id="newPhysicianAcc" src="${pageContext.request.contextPath}/resources/images/add.png"  title="New Physician">
												</div>
												<div class="col-md-5 col-sm-5 col-xs-12">
													<div class="select2-wrapper">
														<select class="autoCompleterPhysicianId select2-single form-control" name="autoCompleterPhysicianId" id="autoCompleterPhysicianId"></select>
														<input type="hidden" id="gdphysicianName" class="form-control">
													</div>
												</div>
												<div class="col-md-1 col-sm-1 col-xs-12 text-center">
													<input type="hidden" id="checkUserType" value="${loginDetail.type}" />
													<img  style="cursor: pointer" class="img-responsive image-center" id="newPhysicianSearch" src="${pageContext.request.contextPath}/resources/images/search3.png"  title="Search">
												</div>
												<div class="col-md-1 col-sm-1 col-xs-12 text-center">
													<img  style="cursor: pointer" class="img-responsive image-center" id="clearPhysicianSearch" src="${pageContext.request.contextPath}/resources/images/search-cancel2.png"  title="Clear">
									...
									<div class="table-responsive">
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left table-responsive">
											<table id="physicianAccountSummaryTable" class="table table-striped jambo_table bulk_action">
												<thead>
													<tr class="heading_background">
														<th>Id</th>
														<th></th>
						...
						<div class="x_panel bgcolorblue2 dashboardHeight">
							...
							<div class="x_content bgcolorblue1">
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left">
										<div class="row form-group">
											...
											<div class="col-md-1 col-sm-1 col-xs-12">
												<!-- <button type="button" class="btn btn-primary">Create New Physician Assistant</button> -->
												<img style="cursor: pointer" class="img-responsive image-center" id="newAssistAcc" src="${pageContext.request.contextPath}/resources/images/add.png"  title="New Physician Assistant">
											</div>
											<div class="col-md-5 col-sm-5 col-xs-12">
												<div class="select2-wrapper">
													<select class="autoCompleterPhysicianAssistantId select2-single form-control" name="autoCompleterPhysicianAssistantId" id="autoCompleterPhysicianAssistantId"></select>
													<input type="hidden" id="gdphysicianAssistantName" class="form-control">
											...
											<div class="col-md-1 col-sm-1 col-xs-12 text-center">
												<input type="hidden" id="checkUserType" value="${loginDetail.type}" />
												<!-- <button type="button" title="Search" id="newSearch" class="btn btn-primary">Search</button> -->
												<img style="cursor: pointer" class="img-responsive image-center" id="newPhysicianAssistantSearch" src="${pageContext.request.contextPath}/resources/images/search3.png"  title="Search">
											</div>
											<div class="col-md-1 col-sm-1 col-xs-12 text-center">
												<!-- <button type="button" id="clearSearch" title="Clear" class="btn btn-primary">Clear</button> -->
												<img style="cursor: pointer" class="img-responsive image-center" id="clearPhysicianAssistantSearch" src="${pageContext.request.contextPath}/resources/images/search-cancel2.png"  title="Clear">
								...
								<div class="table-responsive">
									...
									<table id="adminPhysicianAsstSummaryTable" class="table table-striped jambo_table bulk_action">
										<thead>
											<tr class="heading_background">
												<th>Id</th>
												<th></th>
	...
	<form:hidden path="assistantId" id="assistantId"/>
</form:form>
<!-- /page content -->
<script>
...
<script src="${pageContext.request.contextPath}/resources/js/pages/dashboard/adminDashboard.js?v=3"></script>