 <%--
 Front End UI to generates the Invoice List Report
 --%>
	           	...
	           	<div class="x_content x_title_padding">
					...
					<form:form method="POST" name="form" commandName="form" >
						<div class="row form-group">
							<div class="col-md-2 col-sm-6 col-xs-6 fieldTop">
								<form:input path="invoiceNo" placeholder="Invoice #" class="form-control"  />
							</div>
							<div class="col-md-2 col-sm-6 col-xs-6 fieldTop">
							...
							<div class="col-md-2 col-sm-6 col-xs-6 fieldTop">
								...
								<form:input path="fromRegDate" placeholder="Invoice From" class="form-control calendarIcon"  />
							</div>
							<div class="col-md-2 col-sm-6 col-xs-6 fieldTop">
								<form:input path="toRegDate" placeholder="Invoice To" class="form-control calendarIcon"  />
							</div>
						</div>
						<div class="row form-group">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left table-responsive">
							<table id="invoiceListReport" class="table table-striped table-bordered">
								<thead>
...
<script src="${pageContext.request.contextPath}/resources/js/pages/reports/invoicelist.js?v=1"></script>
