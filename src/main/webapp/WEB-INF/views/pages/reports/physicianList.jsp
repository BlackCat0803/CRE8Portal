 <%--
 Front End UI to generates the Physician List Report
 --%>
	           	...
	           	<div class="x_content x_title_padding">
					...
					<form:form method="POST" name="form" commandName="form" >
						<div class="row form-group">
							<c:choose>
								...
								<c:otherwise>
									<div class="col-md-2 col-sm-6 col-xs-6 fieldTop">
										<select name="autoCompleterClinicId" id="autoCompleterClinicId" style="width:100%;color:black;" 
												class="autoCompleterClinicId select2_single form-control" ></select>
										<form:hidden path="clinic" />
									</div>
								</c:otherwise>
							</c:choose>
							...
							<div class="col-md-2 col-sm-6 col-xs-6 fieldTop">
								<form:input path="deaSearch" placeholder="DEA" class="form-control" />
                       		</div>
                       		<div class="col-md-2 col-sm-6 col-xs-6 fieldTop">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left table-responsive">
							<table id="physicianListReport" class="table table-striped table-bordered">
								<thead>
...
<script src="${pageContext.request.contextPath}/resources/js/pages/reports/physicianlist.js?v=2"></script>
